    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-lg sm:text-xl md:text-2xl text-slate-400 mb-10 max-w-2xl mx-auto">
          Mô tả ý tưởng của bạn — AI team tự phân tích, lên kế hoạch, code, test
          và deploy sản phẩm hoàn chỉnh qua Telegram.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a
            href="#contact"
            className="inline-flex items-center justify-center gap-2 min-h-[44px] px-8 py-3 bg-gradient-to-r from-primary to-blue-600 hover:from-[#2563EB] hover:to-blue-700 text-white font-semibold rounded-lg transition-all duration-200 shadow-lg shadow-primary/25 hover:shadow-primary/40 min-w-[200px]"
          >
            Bắt đầu ngay
